...
const DashboardPage = () => {
  ...
  return (
    <section className="flex flex-col items-center bg-linnear-to-b from-black to-[#1A0033] text-white pb-16 text-sm">
      <img
      ...
      <h1 className="text-4xl md:text-6xl text-center font-medium max-w-3xl mt-5 bg-linnear-to-r from-white to-[#748298] text-transparent bg-clip-text">
        Build. Launch. Scale. Without the complexity.
      </h1>
      <p className="text-slate-100 md:text-base max-md:px-2 text-center max-w-xl mt-3">
        A high-performance, serverless Postgres database that helps you ship fast and scale without
        limits.
      </p>
      ...
      <div className="bg-linnear-to-t from-indigo-900 to-slate-600 p-px rounded-md mt-8">
      ...
      <div className="overflow-hidden w-full relative max-w-5xl mx-auto select-none mt-16">
        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-linnear-to-r from-[#140029] to-transparent"></div>

        <div className="marquee-inner flex will-change-transform min-w-[200%]">
          <div className="flex py-4" id="logo-container"></div>
        </div>

        <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-linnear-to-l from-[#140029] to-transparent"></div>
      </div>
    </section>
  );
};
